  ...
  return {
    ExpressionStatement: function(node) {
      ...
      var matches =
        ...
        // [CODE REVIEW]: Can you move all 7 regexps to an array at the top
        // somewhere, and then refactor the code here to just loop over this
        // array? It looks like you're just doing the same thing over and over
        // again, so the code could be made shorter.
      if (matches) {
        var name = matches[1];
